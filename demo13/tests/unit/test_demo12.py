...
class TestDemo12:
    ...
    def test_app_using_xml_serializer_to_handle_csv_serialize_error_json(self,
                                                                         caplog,
                                                                         app_with_xml_serializer: EventApplication,
                                                                         error_handler_factory):
        caplog.set_level(logging.ERROR)
        ...
        error_handler_factory.register_handler(XmlSerializeError, handle_xml_serialize_error_json)
        error_handler = error_handler_factory.get_handler(e.type)
        error_handler(e.value)
