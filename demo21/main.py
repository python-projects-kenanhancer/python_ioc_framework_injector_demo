...
def test_greeting_strategy(injector: Injector, greeting_type_str: str):

    greeting_type = GreetingType[greeting_type_str.upper()]
...
if __name__ == "__main__":
    ...
    test_greeting_strategy(injector, "holiday")

    test_greeting_strategy(injector, "time_based")
